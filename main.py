...
def criar_colaborador(colaborador: ColaboradorCreate, db: list = Depends(get_db)):
...
def obter_colaborador(matricula: str, db: list = Depends(get_db)):
...
def editar_colaborador(matricula: str, dados: ColaboradorCreate, db: list = Depends(get_db)):
...
def alterar_status(matricula: str, status: StatusColaborador, db: list = Depends(get_db)):
